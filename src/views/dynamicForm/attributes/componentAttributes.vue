<template>
  <el-form :model="currentItem" v-if="currentItem">
    ...
    <!-- <el-form-item label="字段标签对齐">
      <el-button-group v-model="currentItem.props.labelPosition">
  ...
  <el-form v-model="currentItem.props.options" v-if="currentItem && currentItem.props.options">
    <el-divider>
      <span>选择设置</span>
    </el-divider>
...
const currentItem: Widget | undefined = inject('currentItem')
